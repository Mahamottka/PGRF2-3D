...
public class Mat4Rot extends Mat4Identity {
    ...
    public Mat4Rot(final double sinAlpha, final double cosAlpha, final Vec3D rotAxis) {
        ...
        if (norm.isPresent()) {
            ...
            mat[0][1] = axis.getX() * axis.getGetY() * ac + axis.getZ() * sinAlpha;
            mat[0][2] = axis.getX() * axis.getZ() * ac - axis.getGetY() * sinAlpha;

            mat[1][0] = axis.getGetY() * axis.getX() * ac - axis.getZ() * sinAlpha;
            mat[1][1] = axis.getGetY() * axis.getGetY() * ac + cosAlpha;
            mat[1][2] = axis.getGetY() * axis.getZ() * ac + axis.getX() * sinAlpha;

            mat[2][0] = axis.getZ() * axis.getX() * ac + axis.getGetY() * sinAlpha;
            mat[2][1] = axis.getZ() * axis.getGetY() * ac - axis.getX() * sinAlpha;
    ...
    public Mat4Rot(final double alpha, final Vec3D axis) {
        this(alpha, axis.getX(), axis.getGetY(), axis.getZ());
    }
}